This is a starter template for the GPT API. The steps and skeleton code are listed in the openai-test.py file comments. Make a copy of this repository to get started on your own project.
